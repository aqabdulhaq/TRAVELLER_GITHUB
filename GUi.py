...
class LangTRans:
    ...
    def main_window(self):
        ...
        self.window.title("TRAVEL GUIDE")
        self.window.resizable(width=False,height=False)
        self.window.configure(width=1080,height=1080,bg=BG_COLOR)

        head_label=Label(self.window,bg=BG_COLOR,fg=LABEL_COLOR,text="ROAM FREE",font=FONT_BOLD,pady=10)
        ...
        self.msg_entry=Entry(bottom_label,bg="#fff",fg=TEXT_COLOR,font=FONT)
        ...
        send_button=Button(bottom_label,text="TRANSLATE",font=FONT_BOLD,width=8,bg="#4af2ff",command=lambda: self.on_enter(None))
    ...
    def on_enter(self,event):
        ...
        self.my_msg(msg,"WRITTEN TEXT ")
        self.deocded_output(msg,"ça dit")
    ...
    def guide(self):
        ...
        f = open(r"C:\Users\abdul\Downloads\language-translator-ml-codes (1)\language-translator-ml-codes\Ajantacaves.txt", encoding="utf8")
        contents = f.read()
        print(contents)
        ...
        # Text editor
        text = tk.Text(root, height=40, width=300)
        ...
        open_button.grid(column=0, row=1, sticky='w', padx=50, pady=50)
